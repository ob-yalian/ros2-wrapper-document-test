...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('accel_range', default_value='3g'),
        ...
        DeclareLaunchArgument('gyro_range', default_value='250dps'),
        ...
        DeclareLaunchArgument('noise_removal_filter_min_diff', default_value='512'),
        DeclareLaunchArgument('noise_removal_filter_max_size', default_value='240'),
